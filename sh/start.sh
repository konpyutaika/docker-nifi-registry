...
if [ -z ${NIFI_REGISTRY_WEB_HTTP_HOST:-+x} ]; then echo NIFI_REGISTRY_WEB_HTTP_PORT="$HOSTNAME"; fi

prop_replace 'nifi.registry.web.http.port'      "${NIFI_REGISTRY_WEB_HTTP_PORT:-18080}"
prop_replace 'nifi.registry.web.http.host'      "${NIFI_REGISTRY_WEB_HTTP_HOST}"
